...
const EducationSub = ({subMenuName, SubNavItems, StyledSubNav, NavInner, NavList, MobileMenu, MobileMenuList, MobileMenuButton, mobileMenuOpen, handleMobileMenuClick, setnavHover}) => {
    return (
        <>
            <StyledSubNav onMouseOver={() => setnavHover('education')}>
                <Container>
                    <NavInner>
                        <NavList>
