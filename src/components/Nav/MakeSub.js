...
const MakeSub = ({subMenuName, SubNavItems, StyledSubNav, NavInner, NavList, MobileMenu, MobileMenuList, MobileMenuButton, mobileMenuOpen, handleMobileMenuClick, setnavHover}) => {
    return (
        <>
            <StyledSubNav onMouseOver={() => setnavHover('make')}>
                <Container>
                    <NavInner>
                        <NavList>
